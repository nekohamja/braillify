...
#remove hamburger menu and streamlit logo + setup ui elements
st.markdown("""
    <style>
        .css-erpbzb.edgvbvh3
        {
...
st.markdown("<h3 style='text-align: center; color: grey;'>Optical Braille Alphabet Scanner + Text to Speech</h1>", unsafe_allow_html=True)
st.text("")
st.text("")
st.markdown("<p style='text-align: center;'>Note: Clean background and right braille distance for accurate results.</p>", unsafe_allow_html=True)
upload_image = st.file_uploader("Select Braille Image", type=["png","jpg","jpeg"])
...
confidence = 60          #higher - fewer detections
overlap_threshold = 25   #lower - low chance of overlapping labels
